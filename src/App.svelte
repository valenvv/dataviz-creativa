  ...
  <div class="container">
    {#each datos as item}
      <div class="elemento">
        ...
        <div class="flor">
          ...
          {#if obtenerSVGFlor(item.Motivacion)}
            ...
            {#if item.Motivacion == "Entretenimiento"}
              <svg class="flor" width="100" height="100" viewBox="0 0 417 460" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {#if item.Motivacion == "Ninguno"}
              <svg class="flor" width="100" height="100" viewBox="0 0 404 392" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="tallo">
          <object class="tallo" data="{obtenerSVG(item.Horas)}" type="image/svg+xml" width="70" height="100" aria-label="Tallo SVG">
