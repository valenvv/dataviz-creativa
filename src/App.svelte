        ...
        <p class="nombre">{item.Nombre}</p>
          ...
          {#if obtenerSVGFlor(item.Motivacion)}
            {#if item.Motivacion == "Aprendizaje"}
              <svg class="flor"  height="120" viewBox="0 0 417 460" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {#if item.Motivacion == "Ambas"}
              <!-- Flor - AP Y ENT -->
              <svg class="flor"  height="120" viewBox="0 0 529 460" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {#if item.Motivacion == "Ninguno"}
              <!-- Flor - Nada -->
              <svg class="flor" height="120" viewBox="0 0 404 460" fill="none" xmlns="http://www.w3.org/2000/svg">
